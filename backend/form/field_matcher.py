...
INDEX_PHRASES = {
    ...
    "personal.work_auth_eu": "authorized to work european union europe eu visa sponsorship",
    ...
    "preferences.salary_min_usd_annual": "expected salary compensation minimum salary annual base pay",
